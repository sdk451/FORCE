...
export function resolveDefaults(partial: Partial<InstallAnswers>): InstallAnswers {
  ...
  const selfEvolvingRequested =
    partial.include_self_evolving_claude ?? defaultAnswers.include_self_evolving_claude;
  ...
  return {
    ...
    include_self_evolving_claude: selfEvolvingRequested && targets.claude_code,
  };
}
