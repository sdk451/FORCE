...
> If the profile lists **optional skills** or optional packs, keep **Optional skills & packs** in **AGENTS.md** as **name + when to use** only (repo-tightened triggers) — no installer meta, no **`forge-*`** paths or **`SKILL.md`** / matrix copy-paste.  
...
- [ ] Every **`optional_skills`** entry and selected pack (**UI**, **memory**, **hooks**) still appears in **AGENTS.md** as **name + when to use** (no **`forge-*`** / **`SKILL.md`** / matrix prose in the portable runbook).
